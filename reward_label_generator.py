...
def calculate_simulated_ctr(row, screen_width=1280, screen_height=720):
    ...
    simulated_ctr = 1 / (1 + np.exp(- (ctr_score * 10 - 5)))
...
def main():
    ...
    """
    input_path = "./data/preprocessed_waveui.csv"
    output_path = "./data/labeled_waveui.csv"
    ...
    print(df[['type_button', 'type_link', 'area', 'center_x', 'center_y', 'simulated_ctr']].head())
